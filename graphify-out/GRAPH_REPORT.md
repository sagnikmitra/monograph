...
## Corpus Check
- 17 files · ~96,241 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 214 nodes · 238 edges · 19 communities detected
...
3. `MathBlock()` - 4 edges
4. `M()` - 4 edges
5. `_renderMathChildren()` - 4 edges
6. `M()` - 4 edges
7. `MathBlock()` - 4 edges
8. `_mathParse()` - 3 edges
9. `_toTexSource()` - 3 edges
10. `_katexHtml()` - 3 edges
...
Cohesion: 0.05
Nodes (16): besteinsteinSpectrum(), boseMeanOccupation(), cayleySylvester(), ehrhart(), generateQQ(), _katexHtml(), M(), MathBlock() (+8 more)
...
## Knowledge Gaps
- **Thin community `Community 13`** (2 nodes): `RouteFallback()`, `main.jsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 14`** (2 nodes): `useInView.js`, `useInView()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 15`** (2 nodes): `LazyMount()`, `LazyMount.jsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 16`** (2 nodes): `AGENTS.md`, `Memory context`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
